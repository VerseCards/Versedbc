                                ...
                                <div class="col-lg-10 col-md-10">
                                    <div class="theme-detail-card card">
                                        ...
                                        <div class="theme-detail-body">
                                            <div class="row mb-4">
                                                <div class="col-lg-8">
                                                    <p class="mb-2"><?php echo e(__('Background Image:')); ?></p>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="setting-block banner-small-setting">
                                                        <div class="position-relative">
                                                            <img src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo.'/'.$business->logo: asset('custom/img/logo-placeholder-image-2.jpg')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                        ...
                                                        <div class="row">
														<?php if($users->type == 'company' || $users->type == 'techsupport'): ?>
                                                            <div class="col-lg-4">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    <?php echo e(Form::label('Designation', __('Department'), ['class' => 'form-label'])); ?>

                                                                    <?php echo e(Form::text('designation', $business->designation, ['class' => 'form-control', 'id' => $stringid . '_designation', 'placeholder' => __('Enter Department')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    <?php echo e(Form::label('Sub_Title', __('Designation'), ['class' => 'form-label'])); ?>

                                                                    <?php echo e(Form::text('sub_title', $business->sub_title, ['class' => 'form-control ', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Designation' )])); ?>
														...
														<?php else: ?>
															<div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('title', $business->title, ['class' => 'form-control', 'id' => $stringid . '_title', 'placeholder' => __('Enter Title'), 'readonly' => true])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('designation', $business->designation, ['class' => 'form-control', 'id' => $stringid . '_designation', 'placeholder' => __('Enter Department'), 'readonly' => true])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('sub_title', $business->sub_title, ['class' => 'form-control', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Designation' ), 'readonly' => true])); ?>
...
unset($__errorArgs, $__bag); ?>
														...
														<?php endif; ?>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <?php echo e(Form::label('Description', __('Brief Bio'), ['class' => 'form-label'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-9">
                                                    <h5 class="mb-3"><?php echo e(__('Custom link')); ?></h5>
                                                </div>
                                                <div class="col-lg-12">
													<?php if($users->type == 'company' || $users->type == 'techsupport'): ?>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" readonly
                                                                value=" <?php echo e($business_url); ?>"
                                                                placeholder="https://firstbank.com/john-doe">
                                                            <?php echo e(Form::text('slug', $business->slug, ['class' => 'input-group-text text-start d-none', 'placeholder' => __('Enter Custom Link'),'readonly'])); ?>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingSix">
                                                                <button class="accordion-button collapsed"
                                                                    ...
                                                                    <span class="d-flex align-items-center"><?php echo e(__('Social Media Icons')); ?></span>
                                                                    <div class="d-flex align-items-center">
                                                                        <span class="me-2"><?php echo e(__('On/Off:')); ?></span>
                                                                        <div
                                                                            class="form-check form-switch custom-switch-v1">
						...
						<div class="row gy-4">
                                 <div class="col-lg-10 col-md-10">
                                    <div class="theme-detail-card" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff;">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4 ">
                                            <h5 class="mb-0"><?php echo e(__('Thumbail')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <div class="setting-block ">
                                                            <div class="position-relative overflow-hidden rounded">
                                                                <a href="<?php echo e((isset($business->meta_image) && !empty($business->meta_image) ? $business->meta_image : asset('custom/img/placeholder-image1.jpg'))); ?>"
                                                                target="_blank">
...
unset($__errorArgs, $__bag); ?>
										...
										<div class="d-flex align-items-center justify-content-between mb-4 ">
                                            <h5 class="mb-0"><?php echo e(__('')); ?></h5>
                                            <button type="submit" class="btn btn-primary"> <i
                                                    data-feather="folder"></i>&nbsp;<?php echo e(__('Save Thumbail')); ?> </button>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cloveafr/versedbc.clove.africa/resources/views/business/edit.blade.php ENDPATH**/ ?>