...
<body class="tech-card-body">
    ...
    <div id="boxes">
        <div id="view_css"
            class="<?php echo e(\App\Models\Utility::themeOne()['theme19'][$business->theme_color]['theme_name']); ?>" style="padding: 7px; background: #fff9e7">
                                ...
                                <div class="container" style="width: 100%;">
                                    ...
                                    <div class="more-btn">
                                        ...
                                        <?php $__currentLoopData = $leadGeneration_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadgen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
											...
											<a href="javascript:;" class="btn lead-generation<?php echo e($leadgen->id); ?>" tabindex="0" style="width:100%;margin-bottom: 10px;height: 55px;border-radius: 15px;">
                    ...
                    <div class="share-card-wrapper">
                        <div class="section-title">
                            ...
                            <div class="section-title-center">
                                <h5><?php echo e(__('Scan QR Code')); ?></h5>
                            </div>
            ...
            <div class="contact-popup">
                <div class="container">
                    <form class="appointment-form-wrapper contact-form-wrapper">
                        <div class="section-title">
                            <h5><?php echo e(__('Connect With Me')); ?></h5>
...
<?php /**PATH C:\wamp64\www\versedbc\resources\views/card/theme19/index.blade.php ENDPATH**/ ?>