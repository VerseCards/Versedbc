        ...
        <div class="card">
            <div class="card-header card-body table-border-style">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('contacts.export')); ?>" class="btn btn-primary export-btn" style="margin-bottom:30px">
						Export Contacts
					</a>
                </div>
                                        ...
                                        <td class="d-flex">
                                                ...
                                                <div class="action-btn bg-success  ms-2">
                                                    <a href="#"
                                                        ...
                                                        data-title="<?php echo e(__('Add Remark & Change Status')); ?>"
                                                        data-bs-toggle="tooltip"
                                                        data-bs-original-title="<?php echo e(__('Add Remark & Change Status')); ?>"> <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\versedbc\resources\views/contacts/index.blade.php ENDPATH**/ ?>