...
<?php echo e(Form::open(array('url' => route('business.store')))); ?>
    ...
    <div class="row">
        <div class="col-12">
            <?php echo e(Form::label('Business',__('Card Name'),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::text('business_title',null,['class'=>'form-control mt-2', 'placeholder' => __('Enter Business Name')])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="horizontal mt-3">
            <div class="verticals twelve">
                <div class="form-group col-md-6">
                    <?php echo e(Form::label('Select Themes', __('Select Themes & Colour'), ['class' => 'form-control-label'])); ?>
  ...
  <?php /**PATH /home/cloveafr/versedbc.clove.africa/resources/views/business/create.blade.php ENDPATH**/ ?>