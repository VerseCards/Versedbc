...
<body class="tech-card-body">
    <div class="<?php echo e(\App\Models\Utility::themeOne()['theme4'][$business->theme_color]['theme_name']); ?>"
                                    ...
                                    <section class="contact-section" id="contact-div">
                                            ...
                                            <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                                <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($key1 != 'id'): ?>
                                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>" style="border: 1px solid #ffffff3d;justify-content: space-evenly;border-radius: 25px;padding: 15px;margin-top:20px">
                                                                <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <span id="<?php echo e($key1 . '_' . $no); ?>_preview" style="color:#ffffff">
										...
										<div class="more-btn" >
												...
												<div style="border: 1px solid #ffffff3d;justify-content: space-evenly;border-radius: 25px;padding: 15px;margin-top:20px">
													<a href="javascript:;" class="btn make-contact-modal-toggle<?php echo e($leadgen->id); ?>" tabindex="0" style="width:100%; margin-top: 15px; border-radius: 25px;height: 40px; justify-content: flex-end;font-size: 18px;">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><?php echo e(__('Scan QR Code')); ?></h5>
                    </div>
        ...
        <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="btn add-to-contact-btn add-to-contact-botton" style="font-size: 16px; padding: 15px 21px;background-color: var(--black);border: 1px solid var(--contact);"><i class="fa fa-address-card"></i>&nbsp; Add to Contact</a>
    </div>
        <!-- appointment popup -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><?php echo e(__('Connect With Me')); ?></h5>
                    </div>
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn-secondary" id="makecontact"
                                type="button"><?php echo e(__('Connect')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH /home/cloveafr/versedbc.clove.africa/resources/views/card/theme4/index.blade.php ENDPATH**/ ?>